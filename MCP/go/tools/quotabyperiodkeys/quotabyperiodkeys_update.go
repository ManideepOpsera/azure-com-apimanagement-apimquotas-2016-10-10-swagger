...
func Quotabyperiodkeys_updateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.QuotaCounterValueContract
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/quotas/%s/%s%s", cfg.BaseURL, resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, subscriptionId, queryString)
...
func CreateQuotabyperiodkeys_updateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_quotas_quotaCounterKey_quotaPeriodKey",
		...
		mcp.WithString("quotaCounterKey", mcp.Required(), mcp.Description("Quota counter key identifier.")),
